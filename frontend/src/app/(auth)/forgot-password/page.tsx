...
import { Scissors, ArrowLeft, Mail, Phone, ArrowRight, CheckCircle } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-6 py-12">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-white mb-3">Check your {method}</h2>
          <p className="text-gray-400 mb-8">
            We've sent a password reset {method === 'phone' ? 'OTP' : 'link'} to{' '}
            <span className="text-white font-medium">
              {method === 'phone' ? `+91 ${formData.phone}` : formData.email}
            </span>
          </p>
    ...
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-6 py-12">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500">No worries, we'll help you reset it.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            {isLoading ? (
              ...
              <>
                Send Reset {method === 'phone' ? 'OTP' : 'Link'}
                <ArrowRight className="w-5 h-5" />
              </>
            )}
          </button>
